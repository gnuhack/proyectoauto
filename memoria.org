...
** Paquete: Realiza lo anteriormente explicado.

** C. ppal: Actuador de la cinta principal.

** Girar (cambiar RA y RB por éste): Actúa el rodillo en sentido de carga.

** Volver (cambiar RC por éste): Actúa el rodillo en sentido de descarga.

** C.A, C.B, C.C: Actuadores de las cintas A, B y C.

** C. Int: Actuador de la cinta intermedia.

** GIRO_CARGA: Actuador del giro de la plataforma giratoria en sentido antihorario.

** GIRO_DESC: Actuador del giro de la plataforma giratoria en sentido horario.
